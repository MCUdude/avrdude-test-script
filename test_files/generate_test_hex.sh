#!/bin/bash
for i in 16 32 64 128 256 512 768 1024 2048 4096 8192 10240 16384 20480 32768 36864 40960 49152 65536 69632 131072 139264 204800 262144 270336 401408 524288
do
